...
function rowToExamSet(row) {
  ...
  return {
    ...
    setRole: normalizeExamSetRole(row.set_role),
    ...
    sourceExamSetId: row.source_exam_set_id ?? "",
    // snake_case(기본) + camelCase(레거시/디버그 객체) 모두 허용
...
function examSetToRow(examSet) {
  return {
    ...
    set_role: normalizeExamSetRole(examSet.setRole),
    ...
    source_exam_set_id: examSet.sourceExamSetId || null,
